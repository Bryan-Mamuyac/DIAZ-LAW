      ...
      <div className="pt-[68px]" style={{ background: 'var(--bg-canvas)' }}>
        ...
        <div className="relative overflow-hidden py-20" style={{ background: '#07090F' }}>
          ...
          <div className="container-site relative">
            ...
            <p className="font-mono-dm tracking-wide" style={{ fontSize: '0.75rem', color: 'rgba(176,168,156,0.6)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 space-y-5">
              ...
              <div className="card-luxury overflow-hidden">
                ...
                <div className="p-6">
                  <p className="font-display font-medium" style={{ fontSize: '1.125rem', color: 'var(--text-primary)' }}>
              ...
              <div className="card-luxury p-6 space-y-3">
                <p className="font-mono-dm text-xs tracking-widest uppercase mb-4" style={{ color: 'var(--gold)' }}>
                  Contact
                </p>
                {[
                  { Icon: Phone, label: '0995 263 8355',         href: 'tel:09952638355' },
                  { Icon: Mail,  label: 'jushuamari@gmail.com',  href: 'mailto:jushuamari@gmail.com' },
                ].map(({ Icon, label, href }) => (
                  <a
                    key={href}
                    href={href}
              ...
              <div className="card-luxury p-6">
                ...
                <p className="font-medium text-sm" style={{ color: 'var(--text-primary)' }}>DIAZ LAW</p>
                <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>
            ...
            <div className="lg:col-span-8 space-y-7">
              ...
              <div className="card-luxury p-8">
                ...
                >
                  <p>
                    Atty. Jushua Mari Lumague Diaz is a licensed Filipino lawyer and notary public practicing
                    under{' '}
                    <strong style={{ color: 'var(--text-secondary)', fontWeight: 500 }}>DIAZ LAW</strong>.
                    He is committed to delivering accessible, principled, and effective legal services to
                    individuals, families, and small businesses.
                  </p>
                  <p>
                    Whether you need a document notarized, a contract reviewed, or legal representation
                    in a dispute — Atty. Diaz approaches every matter with undivided dedication and
